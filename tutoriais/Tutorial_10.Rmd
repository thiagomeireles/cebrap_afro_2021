---
title: "Tutorial 10: Inícido da coleta de dados no sistema de busca do Estadão"
...
Utilizaremos um *loop* para clicarmos as 8 vezes no botão, indo de 1 a 9. Teremos uma nova função aqui, a *Sys.sleep* que gera um "delay" para que tenhamos a rolagem da página. Criamos tempo de espera de 3 segundos entre o comando para mover nossa página e outro de 2 segundos após clicar e esperar pelo carregamento.
